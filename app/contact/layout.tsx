...
export const metadata: Metadata = {
  ...
  description: 'Contact SafeCert Skills Ltd in Luton for First Aid, Food Hygiene & Health Safety training. Call 0800 123 4567 or email info@safecertskills.co.uk. Open Mon-Sat 8am-8pm.',
  keywords: 'contact SafeCert, training centre Luton, course enquiries, booking information',
  alternates: {
    canonical: 'https://safecertskills.co.uk/contact',
  },
  openGraph: {
    ...
    url: 'https://safecertskills.co.uk/contact',
  },
}
